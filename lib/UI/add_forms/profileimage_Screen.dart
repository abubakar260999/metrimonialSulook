...
class profile_image_screen extends StatefulWidget {
  @override
  _profile_image_screenState createState() => _profile_image_screenState();
}

class _profile_image_screenState extends State<profile_image_screen> {
  @override
  File _image;
  File croppedFile;
  String url;

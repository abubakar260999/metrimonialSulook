...
//                                ),
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          if(lookcaste.text.isEmpty)
                          {
                            empty_Message('Caste');
                          }
                          if(lookagestart.text.isEmpty)
                          {
                            empty_Message('Age');
                          }
                          if(lookageend==null)
                          ...
                          if(lookprofession.text.isEmpty)
                          {
                            empty_Message('Profession');

                          }
                          if(looksalary.text.isEmpty)
                          {
                            empty_Message('Salary');
                          }
                          if(look_height==null)
                          {
                            empty_Message('Height');
                          }
                          if(look_martialstatus==null)
                          {
                            empty_Message('Martial status');
                          }
                          if(look_country==null)
                          {
                            empty_Message("Country");
                          }
                          if(look_city==null)
                          {
                            empty_Message('City');
                          }
                          if(look_explain==null)
                          {
                            empty_Message('Explain');
                          }
                          else
                            {
                              processing_Message();
